...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  if (dt_user_table) {
    ...
    const dt_user = new DataTable(dt_user_table, {
      ...
      columns: [
        { data: 'id' }, // For the checkbox or DT_RowIndex
        { data: 'id' }, // User (or avatar if you display that)
        { data: 'name' }, // Name
        { data: 'mobile', name: 'mobile' }, // ✅ mobile now works
      ...
      columnDefs: [
        ...
        },
        {
          targets: 3,
          render: function (data, type, full, meta) {
            const mobile = full['mobile']; // ✅ Correct variable name
